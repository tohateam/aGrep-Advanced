...
public class Prefs
{
	...
	public static final String KEY_FONTSIZE_EDITOR = "FontSizeEdotor";
	...
	public static final String KEY_UNDO_SIZE = "undoSize";
    ...
    static public Prefs loadPrefes(Context ctx) {
        ...
        prefs.mFontSize = Integer.parseInt(sp.getString(KEY_FONTSIZE , "14"));
		prefs.mFontSizeEditor = Integer.parseInt(sp.getString(KEY_FONTSIZE_EDITOR , "14"));
		...
		prefs.mUndoSize = sp.getInt(KEY_UNDO_SIZE , 50);
    ...
    public void savePrefs(Context context) {
		...
		editor.putString(KEY_FONTSIZE_EDITOR, Integer.toString(mFontSizeEditor));
